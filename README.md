...
> M1–M5 закрыты, M6 GUI в работе (срезы 1–3: консоль, браузерный гейт, редактор). Честная версия: **v0.3**.
...
├── registry.yaml        # реестр: 19 плагинов + 12 пресетов, формат заморожен (maigret/holehe — с v0.3a, SHA-пины)
├── cmd/
...
- В реестре maigret/holehe появятся в **v0.3a** — SHA-пин нового контента
  неизвестен до коммита (дисциплина supply-chain, v0.28a/v0.29): до v0.3a
  подключайте по пути (`plugin: plugins/community/maigret`).
