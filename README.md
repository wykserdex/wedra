# orchestrator v0.23 — контракт рантайма: типы/форматы проверяются, гейт не молчит, журнал атомарный
...
> решаем осознанно, не на бегу. M1–M5 закрыты, M6 GUI **отложен** — ставка на CLI. Честная версия: **v0.23**.
...
## Что нового в v0.23 (контракт и надёжность)
