...
# WEDRA v0.29 — редактор управляет всем: `when`, `foreach`, `parallel`, `retry`
...
> M1–M5 закрыты, M6 GUI в работе (срезы 1–3: консоль, браузерный гейт, редактор). Честная версия: **v0.29**.
...
## Что нового в v0.29 (retry в редакторе)
