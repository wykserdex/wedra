...
# WEDRA v0.7 — v1.0-трек: GUI вшит в бинарник (exe из Release — полный продукт, без репо)
...
> M1–M5 закрыты, M6 GUI в работе (срезы 1–3: консоль, браузерный гейт, редактор). Честная версия: **v0.7**.
...
## Что нового в v0.7 (GUI в бинарнике — release-срез v1.0)
