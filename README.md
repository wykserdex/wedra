# orchestrator v0.22 — GUI-консоль: live-терминал, таймлайн, DAG, запуск из браузера

Локальный оркестратор цепочек с человеком в петле. M1–M5 закрыты, M6 GUI **отложен** — ставка на CLI. Честная версия: **v0.22**.
...
## Что нового в v0.22 (GUI-консоль, первый срез)
