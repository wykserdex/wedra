...
- `runtime.requires` — декларация внешних зависимостей; ядро не устанавливает
  пакеты и не доверяет описанию. Для воспроизводимого plugin зафиксируй
  окружение и lock-файл рядом с plugin, затем проверяй его contract-тестами.
